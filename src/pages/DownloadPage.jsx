          ...
          <div className="w-full space-y-6">
            <div className="p-4 border border-base-300 rounded-xl bg-base-200/50 hover:shadow-inner transition-all space-y-2">
              ...
              <div className="card-actions w-full pt-2">
                <a
                  href="https://github.com/Shlok676/chat-app-frontend/releases/latest/download/Chatty.Setup.1.0.0.exe"
                  target="_blank"
            ...
            <div className="p-4 border border-base-300 rounded-xl bg-base-200/50 hover:shadow-inner transition-all space-y-2">
              ...
              <div className="card-actions w-full pt-2">
                <a
                  href="https://github.com/Shlok676/chat-app-frontend/releases/latest/download/chatty-v-1.0.apk"
                  target="_blank"
                  rel="noopener noreferrer"
